...
<form:form commandName="resveVO" id="detailForm" name="detailForm" method="post">
		...
		<div style="width: 100%; display: inline-flex; padding-bottom: 2px">
			...
			<div style="width: 60%; text-align: left; display: grid">
				...
				<div style="display: inline-flex;">
					<select class="bjWidth form-control" id="mberSn" name="mberSn">
						<c:forEach var="result" items="${listMberNM}" varStatus="status">
							<option value="${result.mberSn}">${result.mberNm} ${result.telno}</option>
						</c:forEach>
					</select>
				</div>
				...
				<!-- 등록자 -->
				<div style="display: inline-flex;"><input type="text" class="bjWidth form-control" id="registId" name="registId" value="${empId}" readonly>
				</div>
	...
	<div class="container" style="text-align: center; margin-top: 30px">
		...
		<button type="button" class="btn btn-info" onclick="resveView()">취소</button>
	</div>
